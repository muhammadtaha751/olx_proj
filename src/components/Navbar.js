    ...
    return (
        ...
        <div className="nav">
            ...
            <div className="navbar_two">
                ...
                <MDBBtn onClick={() => navigate('/postad')}>Sell</MDBBtn>
                </div>
